...
public class WrappedStatement implements Statement {
    ...
    public ResultSet executeQuery(String query) throws SQLException {
        return new WrappedResultSet(this, stmt.executeQuery(conn.handle(query)));
    }

    @Override
    public int executeUpdate(String query) throws SQLException {
        return stmt.executeUpdate(conn.handle(query));
    }
    ...
    public boolean execute(String query) throws SQLException {
        return stmt.execute(conn.handle(query));
    }
    ...
    public void addBatch(String query) throws SQLException {
        stmt.addBatch(conn.handle(query));
    }
